...
class Falcon9Simulation2D {
    constructor(canvas) {
        ...
        this.phases = [
            ...
            { name: 'TOUCHDOWN', duration: 0, throttle: 0, targetAngle: 0 }
        ];
    ...
    drawStage1() {
        ...
        // Choose sprite based on whether stage 2 is separated
        const sprite = this.stage2.visible ? this.sprites.stage1 : this.sprites.full;
