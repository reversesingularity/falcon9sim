...
class Falcon9Simulation {
    constructor() {
        ...
        this.time = 0;
        this.position = { x: 0, y: 40, z: 0 }; // Start 40m above ground (on pad)
    ...
    setPhaseState(phaseIndex) {
        ...
        switch(phaseIndex) {
            ...
            case 1: // Launch & Ascent
                ...
                this.velocity = { x: 0, y: 800, z: 0 };
                this.rotation = { pitch: 0, roll: 0, yaw: 0 };
                this.downrangeDistance = 0;
                break;
            case 2: // Gravity Turn
                this.position = { x: 25000, y: 45000, z: 0 };
                this.velocity = { x: 1200, y: 600, z: 0 };
                this.rotation = { pitch: 45 * Math.PI / 180, roll: 0, yaw: 0 };
                this.downrangeDistance = 25000;
                break;
            case 3: // Stage Separation
                this.position = { x: 45000, y: 65000, z: 0 };
                this.velocity = { x: 1800, y: 300, z: 0 };
                this.rotation = { pitch: 45 * Math.PI / 180, roll: 0, yaw: 0 };
                this.downrangeDistance = 45000;
                break;
            case 4: // Boost-back Burn
                this.position = { x: 55000, y: 70000, z: 0 };
                this.velocity = { x: -500, y: -200, z: 0 };
                this.rotation = { pitch: 135 * Math.PI / 180, roll: 0, yaw: 0 };
                this.downrangeDistance = 55000;
                break;
            case 5: // Coast Phase
                this.position = { x: 30000, y: 50000, z: 0 };
                this.velocity = { x: -600, y: -700, z: 0 };
                this.rotation = { pitch: 180 * Math.PI / 180, roll: 0, yaw: 0 };
                this.downrangeDistance = 30000;
                break;
            case 6: // Re-entry Burn
                this.position = { x: 8000, y: 25000, z: 0 };
                this.velocity = { x: -300, y: -800, z: 0 };
                this.rotation = { pitch: 180 * Math.PI / 180, roll: 0, yaw: 0 };
                this.downrangeDistance = 8000;
                break;
            case 7: // Aerodynamic Descent
                this.position = { x: 2000, y: 8000, z: 0 };
                this.velocity = { x: -100, y: -400, z: 0 };
                this.rotation = { pitch: 180 * Math.PI / 180, roll: 0, yaw: 0 };
                this.downrangeDistance = 2000;
                break;
            case 8: // Landing Burn
                this.position = { x: 200, y: 800, z: 0 };
                this.velocity = { x: -20, y: -80, z: 0 };
                this.rotation = { pitch: 180 * Math.PI / 180, roll: 0, yaw: 0 };
